/* @ts-self-types="./dcpdoctor_wasm.d.ts" */
...
export class Sha1Hasher {
    ...
    finalize() {
        ...
        try {
            const ptr = this.__destroy_into_raw();
            const ret = wasm.sha1hasher_finalize(ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
if (Symbol.dispose) Sha1Hasher.prototype[Symbol.dispose] = Sha1Hasher.prototype.free;
...
export function sha1_base64(data) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sha1_base64(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./dcpdoctor_wasm_bg.js": import0,
    };
}

const Sha1HasherFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sha1hasher_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('dcpdoctor_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
